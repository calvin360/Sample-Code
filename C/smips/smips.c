...
//This program emulates a small portion of the MIPS instruction set
//when given a set  of codes that represents an instruction
//The program has the output of:
